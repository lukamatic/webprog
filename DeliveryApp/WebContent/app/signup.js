            ...
            <div class="d-flex flex-column align-items-center w-50 p-4 mt-5 bg-white box-shadow">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="dateOfBirth" id="dateOfBirth" placeholder="date of birth"  v-model="dateOfBirth"
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="passwordConfirmation" id="passwordConfirmation" placeholder="confirm password" v-model="passwordConfirmation"
                                class="ml-2 input-size"></td>
                    </tr>
                    <tr>
...
`,
  methods: {
    ...
    validateInput: function() {
      if (!this.newUser.firstName || !this.newUser.lastName || !this.newUser.dateOfBirth || !this.newUser.gender
    ...
    createCustomer: function() {
    	const vm = this;
	  	axios.post('/DeliveryApp/rest/customers/create', this.newUser)
